...
const Products = () => {
  ...
  return (
    <div
     ...
     className='flex lg:h-[1500px]  bg-[url("https://img.freepik.com/free-vector/mother-lifting-baby-characters-card_603843-2233.jpg?w=1380&t=st=1694151749~exp=1694152349~hmac=4b4653dfa41e1e0654409ae1c6f6f27d2a480755af33b914c1ebf775b201f1e5")] lg: justify-center flex-col   text-center  mb-[100px] mt-[350px]  lg:bg-cover '>
