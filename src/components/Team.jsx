...
const Team = () => {
  ...
  return (
    <div className='flex justify-center  bg-[url("https://raw.githubusercontent.com/arvinder0603/NeontramOfficial/main/src/assets/bg.jpg?token=GHSAT0AAAAAACD7TIVTM5B4BAKDIDCFLH24ZHCKYWQ")] bg-no-repeat bg-cover'>
